...
int main() {
    ...
    Sphere* sphere2 = new Sphere(vec3(50, 600, -50), 30, vec3(80,255,80));
    ...
    PointLight* plight = new PointLight(vec3(-20, 1000, 0), vec3(1,1,1), 1.3);
    ...
    sphere2->rotate(vec3(0,1000,0), vec3(0,0,1), 70);
    plane1->texture();
