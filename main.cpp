...
int main() {
    ...
    Sphere* sphere4 = new Sphere(vec3(150, 440, -70), 1000);
    
    Plane* plane1 = new Plane(vec3(0,0,-100), vec3(0,0,1));

    Cylinder* cylinder1 = new Cylinder(vec3(-120,420,-100), 20, 100);
    
    Cone* cone1 = new Cone(vec3(-100,370,-100), 30, 60);

    Triangle* tri1 = new Triangle(vec3(0,0,0), vec3(-100,0,100), vec3(100,0,100));

    PointLight* plight1 = new PointLight(vec3(-50,350, 100), vec3(1,1,1), 2.3);
    PointLight* plight2 = new PointLight(vec3(150, 440, 400), vec3(1,1,1), 1.0);
    DirectionalLight *dlight1 = new DirectionalLight(vec3(-1,0,-1), vec3(1,1,1), 0.7);
    ...
    sphere4->setTexture(vec3(135, 206, 235));
    ...
    tri1->rotateSelf(vec3(0,0,1), 170);
