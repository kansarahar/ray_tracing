...
main: main.o vec3.o camera.o material.o sphere.o plane.o pointlight.o directionallight.o ambientlight.o scene.o
	$(CXX) $(CXXFLAGS) main.o vec3.o camera.o material.o sphere.o plane.o pointlight.o directionallight.o ambientlight.o scene.o -o main
